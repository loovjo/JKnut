...
public abstract class BlockType {
	...
	public boolean overrideRender = false;
	...
	public static BlockType WALL = new BlockTypeWall('#',
			ImageLoader.getImage("/Texture/Objects/Block.png").toBufferedImage());
	public static BlockType FLOOR = new BlockTypeFloor(' ',
			ImageLoader.getImage("/Texture/Objects/Ground.png").toBufferedImage());
	public static BlockType WATER = new BlockTypeWater('w',
			ImageLoader.getImage("/Texture/Objects/Water.png").toBufferedImage());
	public static BlockType FIRE = new BlockTypeFire('f',
			ImageLoader.getImage("/Texture/Objects/Fire.png").toBufferedImage());
	public static BlockType ICE = new BlockTypeIce('i',
			ImageLoader.getImage("/Texture/Objects/Ice.png").toBufferedImage());
	public static BlockType KEX = new BlockTypeKex('k',
			ImageLoader.getImage("/Texture/Objects/Point.png").toBufferedImage());
	public static BlockType KEX_DOOR = new BlockTypeKexDoor('h',
			ImageLoader.getImage("/Texture/Objects/KexDoorClosed.png").toBufferedImage(),
			ImageLoader.getImage("/Texture/Objects/KexDoorOpen.png").toBufferedImage());
	public static BlockType PORTAL = new BlockTypePortal('o',
			ImageLoader.getImage("/Texture/Objects/Portal.png").toBufferedImage());
	public static BlockType SUBMERGED_MOVABLE = new BlockTypeMovableSubmerged('d');
	public static BlockType TF_BLOCK_STATE_1 = new BlockTypeTF('E',
			ImageLoader.getImage("/Texture/Objects/TFBlock.png").toBufferedImage(), false);
	public static BlockType TF_BLOCK_STATE_2 = new BlockTypeTF('e',
			ImageLoader.getImage("/Texture/Objects/TFBlock.png").toBufferedImage(), true);
	public static BlockType TANK_BUTTON = new BlockTypeTankButton('.',
			ImageLoader.getImage("/Texture/Objects/T_Button.png").toBufferedImage());
	public static BlockType TF_BUTTON = new BlockTypeTFButton('!',
			ImageLoader.getImage("/Texture/Objects/TFButton.png").toBufferedImage());
	public static BlockType TELEPORTER = new BlockTypeTeleporter('c',
			ImageLoader.getImage("/Texture/Objects/Teleporter.png").toBufferedImage());
	public static BlockType THEIF = new BlockTypeTheif('t',
			ImageLoader.getImage("/Texture/Objects/Thief.png").toBufferedImage());
	...
	public static BlockType WALL_REAL = new BlockTypeFakeWall('=',
			ImageLoader.getImage("/Texture/Objects/BlueWall.png").toBufferedImage(), false);
	public static BlockType WALL_BUTTON = new BlockTypeWallButton('_',
			ImageLoader.getImage("/Texture/Objects/Button.png").toBufferedImage());
